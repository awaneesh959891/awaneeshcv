...
export const project = [
    {
        ...
        image: 'https://awaneeshcv.blob.core.windows.net/awaneeshcv/copeople.png',
        git:'#',
        technologies:['.Net' ,'HTML' , 'CSS' , 'JS']
    },
    {
        title:'Snap Shot',
        ...
        image: 'https://awaneeshcv.blob.core.windows.net/awaneeshcv/vpn.png',
        git:"",
